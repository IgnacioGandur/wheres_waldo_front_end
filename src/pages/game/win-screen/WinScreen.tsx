...
import InputErrors from "./input-errors/InputErrors";
        ...
        <AnimatePresence mode="wait">
            ...
            >
                ...
                <div className={styles["container"]}>
                    <h1>You won!</h1>
                    <h2>
                        You found all characters in {timer.minutes < 10 && "0"}
                    ...
                    {fetcher.data?.scoreCreated ? (
                        ...
                        <>
                            {fetcher.data?.scoreCreationFailed && (
                                <InputErrors
                                    inputErrorObject={fetcher.data.inputErrors}
                                />
                            )}
                            <fetcher.Form
                            ...
                            >
                                ...
                                <div className={styles["input-wrapper"]}>
                                    ...
                                    <div
                                        className={styles["vertical-separator"]}
                                    ></div>
                                    <input
