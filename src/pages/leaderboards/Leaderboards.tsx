...
const Leaderboards = () => {
    ...
    const previousLeaderboard = () => {
        ...
        setLeaderboardIndexes((prevIndexes) => ({
            previous:
                (prevIndexes.current - 2 + allLeaderboards.length) %
                allLeaderboards.length,
            current:
                (prevIndexes.current - 1 + allLeaderboards.length) %
                allLeaderboards.length,
            next: prevIndexes.current,
        }));
    };

    useEffect(() => {}, [leaderboardIndexes]);
        ...
        <>
            ...
            <main className={styles["leaderboards"]}>
                <header className={styles["header"]}>
                    <span className="material-symbols-sharp">trophy</span>
                    <h1>Leaderboards</h1>
                </header>
                <div className={styles["wrapper"]}>
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <Leaderboard
                                scores={
                                    allLeaderboards[leaderboardIndexes.previous]
                                        .scores
                                }
                                gameName={
                                    allLeaderboards[leaderboardIndexes.previous]
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <button
                                ...
                                className={
                                    styles["previous-leaderboard-button"]
                                }
                            >
                            ...
                            <Leaderboard
                                key="current"
                                scores={
                                    allLeaderboards[leaderboardIndexes.current]
                                        .scores
                                }
                                gameName={
                                    allLeaderboards[leaderboardIndexes.current]
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <AnimatePresence mode="wait">
                                <Leaderboard
                                    scores={
                                        allLeaderboards[leaderboardIndexes.next]
                                            .scores
                                    }
                                    gameName={
                                        allLeaderboards[leaderboardIndexes.next]
