...
const Leaderboard = ({ scores, gameName, extraStyles }: LeaderboardProps) => {
    return (
        <motion.ul
        ...
        >
            <div className={styles["header"]}>
                <span
                    className={`material-symbols-sharp ${styles["trophy-icon"]}`}
                >
                    leaderboard
                </span>
            ...
            {scores.length === 0 ? (
                <div className={styles["empty-score"]}>
                    ...
                    >
                        <path
                            fill="currentColor"
                            d="M32 2C15.428 2 2 15.428 2 32s13.428 30 30 30s30-13.428 30-30S48.572 2 32 2m0 57.5C16.836 59.5 4.5 47.164 4.5 32S16.836 4.5 32 4.5S59.5 16.836 59.5 32c0 1.357-.103 2.69-.294 3.996c-.838-5.66-5.69-10.766-5.69-10.766s-5.828 6.113-5.828 12.375c0 6.353 6.393 7.996 9.708 4.937C53.251 52.488 43.431 59.5 32 59.5"
                        ></path>
                        <circle
                            cx={38.498}
                            cy={35}
                    ...
                    <p>Seems like nobody has submitted a score yet...</p>
                </div>
            ) : (
                    ...
                    return (
                        ...
                        >
                            ...
                            <span className={styles["date"]}>
                                {format(
                                    score.createdAt,
                                    "MMMM do, yyyy 'at' hh:mmaa",
                                )}
                            </span>
                            <p className={styles["username"]}>
                                {score.username}
                            </p>
                            <h3 className={styles["time-title"]}>Time</h3>
